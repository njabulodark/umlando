...
var phone = document.getElementById('acc-password').value;
if(phone.length == 0) {
...
producePrompt('Password must be only digits' ,'password-error', 'red');
return false;
}
...
<body>
  <div class="container">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="acc-password" name="acc-password" placeholder="Enter password" onkeyup='validatePassword()'required>
        <span class='error-message' id='password-error'></span>
    </div>
    <div class="form-group">
        <label for="acc-email">Email address</label>
        <input type="email" class="form-control" id="acc-email" name="acc-email" placeholder="Enter Email" onkeyup='validateEmail()'required>
